      ...
      questions: [
        {
          ...
          a: "Savage House supports USDT, BTC, ETH, and other major cryptocurrencies. The exact list may vary by payment provider.",
        },
        {
      ...
      questions: [
        {
          ...
          a: "Savage House allows adult content for users 18+. All content must comply with our Terms of Service and Acceptable Use Policy. Prohibited content includes illegal material, non-consensual content, and content violating intellectual property rights.",
        },
        {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Find answers to common questions about Savage House
          </p>
        </div>
