    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            You must be at least 18 years old to use Savage House. By using this platform, you confirm that you are of legal age in your jurisdiction to view and participate in adult content.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Savage House charges platform fees on transactions. Creators receive a percentage of earnings after platform fees are deducted.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Savage House is provided &quot;as is&quot; without warranties. We are not liable for any damages arising from use of the platform.
          </p>
        </section>
