      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monetize Your Content on Savage House
          </h1>
        ...
        <section className="mb-16">
          ...
          <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Savage House offers competitive revenue sharing. Earnings from subscriptions, tips, and paid content 
        ...
        <section className="text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white p-12 rounded-lg">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join Savage House today and start monetizing your content.
          </p>
          <Link
            href="/register?role=CREATOR"
            onClick={() => {
